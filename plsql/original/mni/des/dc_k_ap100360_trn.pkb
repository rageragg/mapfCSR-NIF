   ...
   BEGIN
    ...
    THEN
      --
        ptraza('p_lee_error',
                   'a',
                   'p_look_up_tip_situ_proc (p_tip_situ_proc p_nom_tip_situ_p) ' ||p_tip_situ_proc || ' ' || p_nom_tip_situ_p);
   ...
   */
   ...
   BEGIN
    --
     ptraza('p_lee_error',
                   'a',
                   'p_v_tip_situ_proc 1 (p_tip_situ_proc p_nom_tip_situ_p) ' ||p_tip_situ_proc || ' ' || p_nom_tip_situ_p);
    ...
    --
     ptraza('p_lee_error',
                   'a',
                   'p_v_tip_situ_proc 2 (p_tip_situ_proc p_nom_tip_situ_p) ' ||p_tip_situ_proc || ' ' || p_nom_tip_situ_p);
    pp_lee_tip_situ_proc (p_tip_situ_proc,p_nom_tip_situ_p);
    --
            ...
            THEN
               --
                 ptraza('p_proceso_fpsl',
                   'a',
                   'Inicia ( p_idn_int_proc) ' ||p_idn_int_proc  );
               ...
               --
                  ptraza('p_proceso_fpsl',
                   'a',
                   'Final ( p_idn_int_proc) ' ||p_idn_int_proc  );
            END IF;
            --
            IF p_mca_errores = 'A'
            THEN
