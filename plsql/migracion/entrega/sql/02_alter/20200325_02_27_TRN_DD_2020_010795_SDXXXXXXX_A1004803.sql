...
BEGIN
  ...
  IF l_valida <> 1 THEN
  --
EXECUTE IMMEDIATE 'ALTER TABLE TRON2000.A1004803 ADD IDN_LIC_LRC VARCHAR2(3) NULL';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN TRON2000.A1004803.IDN_LIC_LRC IS ''INDICADOR QUE IDENTIFICA SI LA POLIZA SE REFIERE AL CALCULO DE UNA LIC O LRC PASIVOS''';
  --
  END IF;
--
END;
