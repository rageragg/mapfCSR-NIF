...
BEGIN
  ...
  IF l_existe_tab = 1 THEN
    ...
    IF l_valida <> 1 THEN
    --
      DBMS_OUTPUT.PUT_LINE(TO_CHAR(SYSDATE,'YYYY/MM/DD HH24:MI:SS')||' A1004809 Starting operation.');
      EXECUTE IMMEDIATE 'ALTER TABLE TRON2000.A1004809 MODIFY(TXT_MET_VAL VARCHAR2(4) )';
      DBMS_OUTPUT.PUT_LINE(TO_CHAR(SYSDATE,'YYYY/MM/DD HH24:MI:SS')||' A1004809 Change done.');
    ELSE
      DBMS_OUTPUT.PUT_LINE(TO_CHAR(SYSDATE,'YYYY/MM/DD HH24:MI:SS')||' A1004809 Operation already exists. No change has been performed.');
    --
    END IF;
  ELSE
    DBMS_OUTPUT.PUT_LINE(TO_CHAR(SYSDATE,'YYYY/MM/DD HH24:MI:SS')||' A1004809 Table doesn''t exist. No change has been performed.');
    --
  END IF;
--
END;
