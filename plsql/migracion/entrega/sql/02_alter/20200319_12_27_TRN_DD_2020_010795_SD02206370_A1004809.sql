...
BEGIN
  ...
  IF l_valida <> 1 THEN
  --
EXECUTE IMMEDIATE 'ALTER TABLE TRON2000.A1004809 ADD VAL_MCA_INT VARCHAR2(10) NULL';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN TRON2000.A1004809.VAL_MCA_INT IS ''VALOR UTILIZADO POR NUCLEO PARA VALIDACIONES INTERNAS''';
  --
  END IF;
--
END;
