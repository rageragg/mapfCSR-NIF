...
SELECT COUNT(*) INTO l_count
 FROM G1010020
 WHERE  COD_MENSAJE =  NVL (99977914,COD_MENSAJE) AND  COD_IDIOMA IN ('ES','EN') AND  COD_INSTALACION != 'TRN' AND ROWNUM = 1;
IF l_count = 1
THEN
   DBMS_OUTPUT.PUT_LINE('EXISTE UNA PERSONALIZACION EN EL CONCEPTO "01_MENSAJES" PARA LA TABLA "G1010020" (99977914-TRN)');
   DBMS_OUTPUT.PUT_LINE('THERE IS A CUSTOMIZATION IN THE CONCEPT "01_MENSAJES" FOR TABLE "G1010020" (99977914-TRN)');
...
UPDATE G1010020
 ...
 WHERE  COD_MENSAJE = 99977914 AND  COD_IDIOMA = 'EN'
;
END;
BEGIN 
INSERT INTO G1010020
...
UPDATE G1010020
 ...
 WHERE  COD_MENSAJE = 99977914 AND  COD_IDIOMA = 'ES'
;
END;
END IF;
END;
