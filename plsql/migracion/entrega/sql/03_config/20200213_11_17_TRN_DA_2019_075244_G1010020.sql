...
SELECT COUNT(*) INTO l_count
 FROM G1010020
 WHERE  COD_MENSAJE =  NVL (10532,COD_MENSAJE) AND  COD_IDIOMA IN ('ES','EN') AND  COD_INSTALACION != 'TRN' AND ROWNUM = 1;
IF l_count = 1
THEN
...
UPDATE G1010020
 SET  TXT_MENSAJE = 'DATA GENERATED', COD_INSTALACION = 'TRN', MCA_MENSAJE = 'S'
 WHERE  COD_MENSAJE = 10532 AND  COD_IDIOMA = 'EN'
;
END;
BEGIN 
INSERT INTO G1010020
...
WHEN DUP_VAL_ON_INDEX THEN 
UPDATE G1010020
 SET  TXT_MENSAJE = 'DATOS GENERADOS', COD_INSTALACION = 'TRN', MCA_MENSAJE = 'S'
 WHERE  COD_MENSAJE = 10532 AND  COD_IDIOMA = 'ES'
;
END;
END IF;
END;
