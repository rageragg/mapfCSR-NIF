...
AS
   ...
   */
   ...
   BEGIN
      ...
      pp_comprueba_error;
      --
      RETURN greg.cod_ratio_combinado;
      --
   ...
   */
   FUNCTION f_inserta(p_reg      IN    a1004811%ROWTYPE)
    --
   RETURN ROWID
   IS
      --
   ...
   */
   ...
   BEGIN
     ...
     WHERE 
       ...
       AND cod_cohorte         = p_reg.cod_cohorte        
       AND cod_cartera         = p_reg.cod_cartera        
       AND tip_registro_paa    = p_reg.tip_registro_paa   
          ;
        --
    END p_actualiza;
   --
